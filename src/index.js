...
import UploadManager from './component/upload';
...
// sdk版本信息
const version = 'vod-miniapp-sdk-1.0.0';
...
class PlvVideoUpload extends PubSub {
   ...
   */
  async addFile(file, events = {}, fileSetting = {}) {
    const fileData = await generateFileData(file, fileSetting, this.userData);
    // 拦截重复文件
  ...
  _handleUploadStatusChange(res) {
    ...
    switch (res.code) {
      ...
      case 101: // init请求失败，或，Upload上传失败
      case 104: // 暂停上传
      case 105: { // Upload ID 不存在
